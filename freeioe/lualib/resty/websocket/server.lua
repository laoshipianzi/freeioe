...
local bitloaded, bit = pcall(require, "bit")
...
local band = bitloaded and bit.band or function(a, b) return a & b end
local rshift = bitloaded and bit.rshift or function(x, b) return x >> b end
local type = type
